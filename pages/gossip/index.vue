<template>
    <div class="container wrapper" >  
      <h1 class="text-center text-5xl font-semibold my-6" >Our Latest <span class="text-[var(--spice)]" >Gossips</span> 🌶👀</h1>
      <div v-if="blogs.length" class="cards" >
      ...
      <p v-else class="text-3xl text-center font-medium my-8" >Loading latest gossip...</p>
      <h1 class="text-2xl font-medium text-center my-2" >Oh! Refresh for more gossip! 😂</h1>
      <h1 class="text-2xl font-medium text-center my-2" >Orrrrrr Publish yours! 😉</h1>
      <div class="btn-wrap">
